...
"""Test mathrace_interaction.live_journal_to_live_turing on journals in data and turing models."""
...
def test_live_journal_to_live_turing_on_data(journal: io.StringIO, journal_name: str) -> None:
